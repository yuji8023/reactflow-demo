...
import { VariableX } from '@/components/workflow/icons';
    ...
    >
      <PortalToFollowElemTrigger className="w-full">
        ...
        >
          ...
          <div className="ml-1 shrink-0 text-xs font-normal capitalize text-text-tertiary">
            {itemData.type}
          </div>
          {isObj && (
            <RightOutlined
  ...
  return (
    <>
      {!hideSearch && (
        <>
          <div
            className={cn('mx-2 mb-1 mt-2', searchBoxClassName)}
